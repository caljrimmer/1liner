...
},{}],"node_modules/lodash.isarray/index.js":[function(require,module,exports) {
/**
...
},{}],"node_modules/lodash.round/index.js":[function(require,module,exports) {
var global = arguments[3];
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
...
},{}],"node_modules/lodash.min/index.js":[function(require,module,exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
},{}],"node_modules/lodash.max/index.js":[function(require,module,exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
},{}],"node_modules/lodash.mean/index.js":[function(require,module,exports) {
/**
...
},{}],"node_modules/lodash.sumby/index.js":[function(require,module,exports) {
var global = arguments[3];
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
...
},{}],"node_modules/lodash.isundefined/index.js":[function(require,module,exports) {
/**
...
function __getEquator(item) {
  ...
  if (!selected) throw new Error("Equator error: no equator exists for ".concat(item));
  return selected;
}
...
function __checkOperator(element) {
  ...
  if (!check && element.includes('(')) throw new Error("Operator error: no operator exists for ".concat(element));
  return check;
}
...
function __getOperatorValue(element, segment) {
  ...
  if (!opValue) {
    ...
    if (opValue === '') throw new Error("Operator error: No value in ".concat(element, " (in ").concat(segment, ")"));
    throw new Error("Operator error : No value in ".concat(element, " (in ").concat(segment, ")"));
  }
...
function __recursive(obj, el, nextEl, segment) {
  ...
  if (__checkOperator(nextEl)) {
    ...
    if (!obj) throw new Error("Path error: no object exists at ".concat(el, " (in ").concat(segment));
    if (!obj[el]) throw new Error("Path error: ".concat(el, " (in ").concat(segment, ")"));
    if (isArray(obj[el])) throw new Error("Array error: ".concat(el, ". (in ").concat(segment, ") should be followed by operator i.e. count(), filter() as it is an array"));
    return obj[el];
  }

  if (nextEl.includes('filter(')) {
    var item = __getOperatorValue(nextEl, segment);
  ...
  if (nextEl.includes('unique(')) {
    var _key = __getOperatorValue(nextEl, segment);

    return unique(newObj, _key);
  }
  ...
  if (nextEl.includes('sum(')) {
    var _key3 = __getOperatorValue(nextEl, segment);

    return round(sumBy(newObj, _key3), 2);
  }
  ...
  _createClass(L, [{
    ...
    value: function singleQuery(segment) {
      ...
      if (!__checkOperator(segment)) {
        var obj = get(result, segment);
        if (isUndefined(obj)) throw new Error("Path error : No object path for ".concat(segment));
        return obj;
      } // Traverse object
